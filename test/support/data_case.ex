defmodule WallabyLiveviewPlayground.DataCase do
  @moduledoc """
  ...
  by setting `use WallabyLiveviewPlayground.DataCase, async: true`, although
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import WallabyLiveviewPlayground.DataCase
    end
  end
